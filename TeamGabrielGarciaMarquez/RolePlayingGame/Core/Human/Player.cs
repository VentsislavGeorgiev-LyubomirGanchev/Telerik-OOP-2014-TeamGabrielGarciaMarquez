...
namespace RolePlayingGame.Core.Human
{
	internal class Player : Human, IMovable, IPlayer
	{
		...
		{
			return this.Position.X < mapSizeXMaxIndex;
		}
		public bool CanMoveLeft(int mapSizeXMinIndex)
		{
			return this.Position.X > mapSizeXMinIndex;
		}
		public bool CanMoveUp(int mapSizeYMinIndex)
		{
			return this.Position.Y > mapSizeYMinIndex;
		}
		public bool CanMoveDown(int mapSizeYMaxIndex)
		{
			return this.Position.X < mapSizeYMaxIndex;
		}
